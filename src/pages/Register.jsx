...
const Register = () => {
  ...
  return (
    <section className="bg-gradient-to-b from-purple-100 to-purple-300 py-16 px-4 min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-md w-full mx-auto sm:max-w-lg animate-slide-up">
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-purple-200 relative z-10">
          {/* Título con Ícono */}
          <div className="flex items-center justify-center mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-gray-800 bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent">
              Crear Cuenta
            </h2>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative animate-fade-in animation-delay-200">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-3 pl-10 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300 hover:border-purple-400 bg-white shadow-inner text-sm sm:text-base"
            ...
            <div className="relative animate-fade-in animation-delay-500">
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full p-3 pl-10 border border-purple-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300 hover:border-purple-400 bg-white shadow-inner text-sm sm:text-base appearance-none"
                >
                ...
                <svg className="absolute right-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-500" fill="currentColor" viewBox="0 0 24 24">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-purple-700 text-white py-3 rounded-lg hover:scale-105 transition-all duration-300 shadow-lg flex items-center justify-center space-x-2 animate-fade-in animation-delay-600"
            >
          ...
          <p className="mt-6 text-center text-gray-600 animate-fade-in animation-delay-700">
            ¿Ya tienes cuenta?{' '}
            <Link to="/login" className="text-purple-600 hover:text-purple-800 hover:underline font-semibold transition-all duration-200">
              Inicia Sesión
            </Link>
          </p>
        </div>
